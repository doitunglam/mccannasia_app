...
<head>
	...
	<title>Publisher Policy &#8211; MCCANNASIA</title>
	...
	<link rel="alternate" type="application/json" href="http://localhost/wordpress/wp-json/wp/v2/pages/502" />
	...
	<link rel="alternate" type="text/xml+oembed"
		href="http://localhost/wordpress/wp-json/oembed/1.0/embed?url=http%3A%2F%2Flocalhost%2Fwordpress%2Fpublisher-policy%2F&#038;format=xml" />
...
<body
	class="page-template-default page page-id-502 wp-custom-logo wp-embed-responsive elementor-default elementor-kit-136">
	...
	<div class="wp-site-blocks">
													...
													<li style="font-size: 15px;"
														class="wp-block-navigation-item wp-block-navigation-link"><a
															...
															href="{{route("home.publisherOverview")}}" title=""><span
																class="wp-block-navigation-item__label">Hệ sinh thái
																Publisher</span></a></li>
													<li style="font-size: 15px;"
														class="wp-block-navigation-item current-menu-item wp-block-navigation-link">
														<a class="wp-block-navigation-item__content"
															href="{{route("home.publisherPolicy")}}" aria-current="page"><span
		...
		<div class="is-layout-flow entry-content wp-block-post-content">
			<div id="ez-toc-container"
				class="ez-toc-v2_0_45_2 counter-hierarchy ez-toc-counter ez-toc-grey ez-toc-container-direction">
				<div class="ez-toc-title-container">
					<p class="ez-toc-title">Mục lục</p> <span class="ez-toc-title-toggle"><a href="#"
							class="ez-toc-pull-right ez-toc-btn ez-toc-btn-xs ez-toc-btn-default ez-toc-toggle"
							aria-label="ez-toc-toggle-icon-1"><label for="item-64095bee702a4"
								aria-label="Table of Content"><span
									...
									</svg></span></label><input type="checkbox" id="item-64095bee702a4"></a></span>
				</div>
				<nav>
					<ul class='ez-toc-list ez-toc-list-level-1'>
						<li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-1"
								href="#1_Nghiem_cam_vi_pham_SEM_brandname"
								title="1. Nghiêm cấm vi phạm SEM brandname">1. Nghiêm cấm vi phạm SEM brandname</a></li>
						<li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-2"
								href="#2_Nghiem_cam_spam_data_nguoi_dung_spam_lead_rac"
								title="2. Nghiêm cấm spam data người dùng, spam lead rác">2. Nghiêm cấm spam data người
								dùng, spam lead rác</a></li>
						<li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-3"
								href="#3_Nghiem_cam_co_tinh_gian_lan_lam_gia_thong_tin_nguoi_dung"
								title="3. Nghiêm cấm cố tình gian lận làm giả thông tin người dùng">3. Nghiêm cấm cố
								tình gian lận làm giả thông tin người dùng</a></li>
						<li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-4"
								href="#4_Nghiem_cam_quang_cao_tren_cac_kenh_cua_Nha_cung_cap_doi_thu"
								title="4. Nghiêm cấm quảng cáo trên các kênh của Nhà cung cấp, đối thủ">4. Nghiêm cấm
								quảng cáo trên các kênh của Nhà cung cấp, đối thủ</a></li>
						<li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-5"
								href="#5_Nghiem_cam_reseller" title="5. Nghiêm cấm reseller">5. Nghiêm cấm reseller</a>
						</li>
						<li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-6"
								href="#6_Nghiem_cam_hanh_vi_tao_ra_luong_truy_cap_impression_click_data_ao_doi_voi_cac_chuong_trinh_cua_nha_quang_cao"
								title="6. Nghiêm cấm hành vi tạo ra lượng truy cập (impression, click, data) ảo đối với các chương trình của nhà quảng cáo">6.
								Nghiêm cấm hành vi tạo ra lượng truy cập (impression, click, data) ảo đối với các chương
								trình của nhà quảng cáo</a></li>
						<li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-7"
								href="#7_Nghiem_cam_hanh_vi_co_tinh_gay_hieu_nham_la_nha_quang_cao_lap_fanpage_website_group%E2%80%A6_gay_hieu_nham_la_nha_cung_cap"
								title="7. Nghiêm cấm hành vi cố tình gây hiểu nhầm là nhà quảng cáo ( lập fanpage, website, group,… gây hiểu nhầm là nhà cung cấp)">7.
								Nghiêm cấm hành vi cố tình gây hiểu nhầm là nhà quảng cáo ( lập fanpage, website,
								group,… gây hiểu nhầm là nhà cung cấp)</a></li>
						<li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-8"
								href="#8_Nghiem_cam_cung_cap_cac_thong_tin_sai_lech_nham_tiep_can_nguoi_dung"
								title="8. Nghiêm cấm cung cấp các thông tin sai lệch nhằm tiếp cận người dùng">8. Nghiêm
								cấm cung cấp các thông tin sai lệch nhằm tiếp cận người dùng</a></li>
						<li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-9"
								href="#9_Nghiem_cam_quang_cao_thong_tin_tren_cac_trang_co_noi_dung_doc_hai_vi_pham_dao_duc_va_vi_pham_phap_luat_group_cam_gay_thiet_hai_den_nha_cung_cap_va_ACESSTRADE"
								title="9. Nghiêm cấm quảng cáo thông tin trên các trang có nội dung độc hại, vi phạm đạo đức và vi phạm pháp luật, group cấm gây thiệt hại đến nhà cung cấp và ACESSTRADE">9.
								Nghiêm cấm quảng cáo thông tin trên các trang có nội dung độc hại, vi phạm đạo đức và vi
								phạm pháp luật, group cấm gây thiệt hại đến nhà cung cấp và ACESSTRADE</a></li>
						<li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-10"
								href="#10_Hanh_vi_chay_quang_cao_truc_tiep_toi_trang_nha_quang_cao"
								title="10. Hành vi chạy quảng cáo trực tiếp tới trang nhà quảng cáo">10. Hành vi chạy
								quảng cáo trực tiếp tới trang nhà quảng cáo</a></li>
					</ul>
				</nav>
			</div>
			<h3 style="font-size:18px"><span class="ez-toc-section"
					id="1_Nghiem_cam_vi_pham_SEM_brandname"></span><strong>1. Nghiêm cấm vi phạm SEM
					brandname</strong><span class="ez-toc-section-end"></span></h3>
			<p style="font-size:16px">Hành vi chạy từ khóa thương hiệu hoặc sử dụng từ khóa cố tình viết sai thương hiệu
				để gây nhầm lẫn Quảng cáo “Brand Key” trên các công cụ tìm kiếm (Google Adwords, Cốc Cốc…) hoặc sử dụng
				các dạng biến thể Brand hoặc các từ khóa có chứa brand</p>
			<h3 style="font-size:18px"><span class="ez-toc-section"
					id="2_Nghiem_cam_spam_data_nguoi_dung_spam_lead_rac"></span><strong>2. Nghiêm cấm spam data người
					dùng, spam lead rác</strong><span class="ez-toc-section-end"></span></h3>
			<p style="font-size:16px">Nghiêm cấm các hành vi spam data rác, dữ liệu người dùng và điền thông tin khi
				không được sự cho phép hoặc đồng ý từ người dùng&nbsp;</p>
			<p style="font-size:16px">Định nghĩa: Lead rác: sai số, sai thông tin, thuê bao, Khách nói ngay là không có
				nhu cầu, không để lại thông tin</p>
			<h3 style="font-size:18px"><span class="ez-toc-section"
					id="3_Nghiem_cam_co_tinh_gian_lan_lam_gia_thong_tin_nguoi_dung"></span><strong>3. Nghiêm cấm cố tình
					gian lận làm giả thông tin người dùng</strong><span class="ez-toc-section-end"></span></h3>
			<p style="font-size:16px">Nghiêm cấm Publisher tự đặt hàng rồi hoàn trả, mạo danh Advertiser lừa đảo thông
				tin người dùng hoặc các hành vi gian lận khác</p>
			<p style="font-size:16px">Nghiêm cấm các hành vi làm giả dữ liệu người dùng, tạo các dữ liệu ảo và cấu kết
				với người dùng để thực hiện các hành vi vi phạm</p>
			<p style="font-size:16px">Sử dụng link affiliate hoặc các thông tin của Nhà cung cấp (Advertiser) để thực
				hiện việc quảng cáo trên các diễn đàn, group, cộng đồng, Facebook của các Nhà cung cấp đối thủ.( post
				bài, bình luận,….)</p>
			<h3 style="font-size:18px"><span class="ez-toc-section"
					id="4_Nghiem_cam_quang_cao_tren_cac_kenh_cua_Nha_cung_cap_doi_thu"></span><strong>4. Nghiêm cấm
					quảng cáo trên các kênh của Nhà cung cấp, đối thủ</strong><span class="ez-toc-section-end"></span>
			</h3>
			<h3 style="font-size:18px"><span class="ez-toc-section" id="5_Nghiem_cam_reseller"></span><strong>5. Nghiêm
					cấm reseller</strong><span class="ez-toc-section-end"></span></h3>
			<p style="font-size:16px">Là hoạt động đầu cơ tích trữ, mua đi bán lại các sản phẩm của nhà cung cấp nhằm
				thu lợi bất chính</p>
			<h3 style="font-size:18px"><span class="ez-toc-section"
					id="6_Nghiem_cam_hanh_vi_tao_ra_luong_truy_cap_impression_click_data_ao_doi_voi_cac_chuong_trinh_cua_nha_quang_cao"></span><strong>6.
					Nghiêm cấm hành vi tạo ra lượng truy cập (impression, click, data) ảo đối với các chương trình của
					nhà quảng cáo</strong><span class="ez-toc-section-end"></span></h3>
			<h3 style="font-size:18px"><span class="ez-toc-section"
					id="7_Nghiem_cam_hanh_vi_co_tinh_gay_hieu_nham_la_nha_quang_cao_lap_fanpage_website_group%E2%80%A6_gay_hieu_nham_la_nha_cung_cap"></span><strong>7.
					Nghiêm cấm hành vi cố tình gây hiểu nhầm là nhà quảng cáo ( lập fanpage, website, group,… gây hiểu
					nhầm là nhà cung cấp)</strong><span class="ez-toc-section-end"></span></h3>
			<p style="font-size:16px">VD: Dùng tên thương hiệu, viết sai, viết tắt tên thương hiệu của nhà cung cấp, sử
				dụng logo của nhà cung cấp</p>
			<h3 style="font-size:18px"><span class="ez-toc-section"
					id="8_Nghiem_cam_cung_cap_cac_thong_tin_sai_lech_nham_tiep_can_nguoi_dung"></span><strong>8. Nghiêm
					cấm cung cấp các thông tin sai lệch nhằm tiếp cận người dùng</strong><span
					class="ez-toc-section-end"></span></h3>
			<p style="font-size:16px">VD: Cố tình viết thiếu, viết ấn dụ, nói quá các chương trình của nhà cung cấp nhằm
			...
			<p style="font-size:16px">VD: Quảng cáo trong các group bùng tiền của chiến dịch tài chính, quảng cáo trên
				các trang cấm</p>
			<h3 style="font-size:18px"><span class="ez-toc-section"
					id="10_Hanh_vi_chay_quang_cao_truc_tiep_toi_trang_nha_quang_cao"></span><strong>10. Hành vi chạy
					quảng cáo trực tiếp tới trang nhà quảng cáo</strong><span class="ez-toc-section-end"></span></h3>
		</div>
		...
		<div class="ez-toc-sticky-fixed hide">
			<div class='ez-toc-sidebar'>
				<div class="ez-toc-sticky-title-container">
					<p class="ez-toc-sticky-title">Mục lục</p> <a class="ez-toc-close-icon" href="javascript:void(0)"
						onclick="ezTOC_hideBar(event)" aria-label="×"><span aria-hidden="true">×</span></a>
				</div>
				<div id="ez-toc-sticky-container"
					class="ez-toc-sticky-v2_0_45_2 counter-flat ez-toc-sticky-toggle-counter">
					<nav class='ez-toc-sticky-toggle-direction'>
						<ul class='ez-toc-sticky-list ez-toc-sticky-list-level-1'>
							<li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
									class="ez-toc-link ez-toc-heading-1" href="#1_Nghiem_cam_vi_pham_SEM_brandname"
									title="1. Nghiêm cấm vi phạm SEM brandname">1. Nghiêm cấm vi phạm SEM brandname</a>
							</li>
							<li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
									class="ez-toc-link ez-toc-heading-2"
									href="#2_Nghiem_cam_spam_data_nguoi_dung_spam_lead_rac"
									title="2. Nghiêm cấm spam data người dùng, spam lead rác">2. Nghiêm cấm spam data
									người dùng, spam lead rác</a></li>
							<li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
							...
							<li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
									...
									href="#4_Nghiem_cam_quang_cao_tren_cac_kenh_cua_Nha_cung_cap_doi_thu"
									title="4. Nghiêm cấm quảng cáo trên các kênh của Nhà cung cấp, đối thủ">4. Nghiêm
									cấm quảng cáo trên các kênh của Nhà cung cấp, đối thủ</a></li>
							<li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
									class="ez-toc-link ez-toc-heading-5" href="#5_Nghiem_cam_reseller"
									title="5. Nghiêm cấm reseller">5. Nghiêm cấm reseller</a></li>
							<li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
									class="ez-toc-link ez-toc-heading-6"
									href="#6_Nghiem_cam_hanh_vi_tao_ra_luong_truy_cap_impression_click_data_ao_doi_voi_cac_chuong_trinh_cua_nha_quang_cao"
									title="6. Nghiêm cấm hành vi tạo ra lượng truy cập (impression, click, data) ảo đối với các chương trình của nhà quảng cáo">6.
									Nghiêm cấm hành vi tạo ra lượng truy cập (impression, click, data) ảo đối với các
									chương trình của nhà quảng cáo</a></li>
							<li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
							...
							<li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
									...
									href="#8_Nghiem_cam_cung_cap_cac_thong_tin_sai_lech_nham_tiep_can_nguoi_dung"
									title="8. Nghiêm cấm cung cấp các thông tin sai lệch nhằm tiếp cận người dùng">8.
									Nghiêm cấm cung cấp các thông tin sai lệch nhằm tiếp cận người dùng</a></li>
							<li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
									class="ez-toc-link ez-toc-heading-9"
									href="#9_Nghiem_cam_quang_cao_thong_tin_tren_cac_trang_co_noi_dung_doc_hai_vi_pham_dao_duc_va_vi_pham_phap_luat_group_cam_gay_thiet_hai_den_nha_cung_cap_va_ACESSTRADE"
									title="9. Nghiêm cấm quảng cáo thông tin trên các trang có nội dung độc hại, vi phạm đạo đức và vi phạm pháp luật, group cấm gây thiệt hại đến nhà cung cấp và ACESSTRADE">9.
									Nghiêm cấm quảng cáo thông tin trên các trang có nội dung độc hại, vi phạm đạo đức
									và vi phạm pháp luật, group cấm gây thiệt hại đến nhà cung cấp và ACESSTRADE</a>
							</li>
							<li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
									class="ez-toc-link ez-toc-heading-10"
									href="#10_Hanh_vi_chay_quang_cao_truc_tiep_toi_trang_nha_quang_cao"
									title="10. Hành vi chạy quảng cáo trực tiếp tới trang nhà quảng cáo">10. Hành vi
									chạy quảng cáo trực tiếp tới trang nhà quảng cáo</a></li>
						</ul>
					</nav>
				</div>
			</div>
		</div> <a class='ez-toc-open-icon' href='javascript:void(0)' onclick='ezTOC_showBar(event)'> <span
				class="arrow">&#8594;</span> <span class="text">Index</span> </a>
	</div>
	<script src='./js/easy-table-of-contents-vendor-js-cookie-js.cookie.min.js' id='ez-toc-js-cookie-js'></script>
	<script src='./js/easy-table-of-contents-vendor-sticky-kit-jquery.sticky-kit.min.js'
		id='ez-toc-jquery-sticky-kit-js'></script>
	<script id='ez-toc-js-js-extra'>
		var ezTOC = { "smooth_scroll": "1", "visibility_hide_by_default": "", "width": "auto", "scroll_offset": "30" };
	</script>
	<script src='./js/easy-table-of-contents-assets-js-front.min.js' id='ez-toc-js-js'></script>
