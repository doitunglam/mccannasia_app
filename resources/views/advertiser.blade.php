...
<head>
	...
	<title>Adveritser &#8211; MCCANNASIA</title>
	...
	<link rel="alternate" type="application/json" href="http://localhost/wordpress/wp-json/wp/v2/pages/5" />
	<link rel="EditURI" type="application/rsd+xml" title="RSD" href="http://localhost/wordpress/xmlrpc.php?rsd" />
	<link rel="wlwmanifest" type="application/wlwmanifest+xml"
		href="http://localhost/wordpress/wp-includes/wlwmanifest.xml" />
	<meta name="generator" content="WordPress 6.1.1" />
	<link rel="canonical" href="{{route("home.advertiser")}}" />
	<link rel='shortlink' href='http://localhost/wordpress/?p=5' />
	<link rel="alternate" type="application/json+oembed"
		href="http://localhost/wordpress/wp-json/oembed/1.0/embed?url=http%3A%2F%2Flocalhost%2Fwordpress%2Fadvertiser%2F" />
	<link rel="alternate" type="text/xml+oembed"
		href="http://localhost/wordpress/wp-json/oembed/1.0/embed?url=http%3A%2F%2Flocalhost%2Fwordpress%2Fadvertiser%2F&#038;format=xml" />
...
<body
	class="page-template-default page page-id-5 wp-custom-logo wp-embed-responsive elementor-default elementor-kit-136">
	...
	<div class="wp-site-blocks">
									...
									<div class="wp-block-navigation__responsive-container-content" id="modal-2-content">
										<ul class="wp-block-navigation__container">
											...
											<li style="font-size: 15px;"
												...
												<a class="wp-block-navigation-item__content" href="{{route("home.advertiser")}}"
		...
		<div class="is-layout-constrained entry-content wp-block-post-content">
			<h2 class="font-be" style="font-size:40px"><span class="ez-toc-section"
					id="Quy_khach_co_nhu_cau_hop_tac_xin_moi_lien_he_voi_bo_phan_cham_soc_khach_hang_qua_hotline_hoac_khung_chat_xin_cam_on"></span>Quý
				khách có nhu cầu hợp tác xin mời liên hệ với bộ phận chăm sóc khách hàng qua hotline hoặc khung chat,
				xin cảm ơn.<span class="ez-toc-section-end"></span></h2>
		</div>
