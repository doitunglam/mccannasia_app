...
<head>
	...
	<title>Contact &#8211; MCCANNASIA</title>
	...
	<link rel="alternate" type="application/json" href="http://localhost/wordpress/wp-json/wp/v2/pages/558" />
	...
	<link rel="alternate" type="text/xml+oembed"
		href="http://localhost/wordpress/wp-json/oembed/1.0/embed?url=http%3A%2F%2Flocalhost%2Fwordpress%2Fcontact%2F&#038;format=xml" />
...
<body
	class="page-template-default page page-id-558 wp-custom-logo wp-embed-responsive elementor-default elementor-kit-136">
	...
	<div class="wp-site-blocks">
		...
		<div class="wp-block-cover"><span aria-hidden="true"
			...
			<div class="wp-block-cover__inner-container">
				<p class="has-text-align-center font-be" style="font-size:60px"><strong>LIÊN HỆ</strong></p>
			</div>
		</div>
		<p class="has-text-align-center font-lato" style="font-size:35px"> <strong>VĂN PHÒNG</strong> <br> <strong><span
					style="color: #ff7e02;">MCCANNASIA VIỆT NAM</span></strong> </p>
		<div class="is-layout-constrained wp-block-group">
			<div class="is-layout-flex wp-container-9 wp-block-columns">
				<div class="is-layout-flow wp-block-column">
					<div class="is-layout-constrained wp-container-7 wp-block-group">
						<figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="800"
								height="549" src="./images/2023-03-1104_nha-tho-duc-ba-sai-gon-1.jpg" alt=""
								class="wp-image-564" /></figure>
					</div>
					<p class="font-lato" style="font-size:15px;text-decoration:underline">TRỤ SỞ CHÍNH</p>
					<p class="font-lato" style="font-size:15px">Lầu 3, tòa nhà Viet Solutions, số 125/11 Nguyễn Cửu Vân,
						phường 17, quận Bình Thạnh, TP. Hồ Chí Minh.</p>
				</div>
			</div>
		</div>
